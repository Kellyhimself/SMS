...
import { Menu, X, Home, Users, DollarSign, BookOpen, Bell, Settings, Copyright } from 'lucide-react'
            ...
            <Link href="/settings">
              <Button
                ...
                className={cn(
                  ...
                  'text-base font-medium',
                  'py-3 px-4',
                  pathname.startsWith('/settings') && 'bg-background/80 text-primary border-2',
                )}
                onClick={() => setOpen(false)}
              >
                <Settings className="mr-3 h-5 w-5 transition-transform duration-300 group-hover:scale-110" />
                Settings
              </Button>
            </Link>
